...
return array( 
	...
	'filename' => 'export_'.date('Ymd').'.xml',		// File name for the download
	'mimetype' => 'text/xml',						// Mimetype, leave empty if you don't know what to enter here
	...
	'helpText' => $modx->lexicon('formsave.help_xml'), // Help text to display next to the template field
